...
////    we are then calling that as our first argument:
////    per: font-family: var(--primary-font) -apple-system, BlinkMacSystemFont, Segoe UI, etc.
////    @current-conclusion: at this moment the only fonts being displayed on the user system or the two fonts declared
// in //         the //    --primary-font declaration //    @questions: so far we are unsure about the timing and
// loading of the two fonts, if they do no load in x time, do //         the //    backup fonts kick in //		 */
// //		font - family; //	: //		var (; //		--primary - font; //	), //		-apple - system,
// BlinkMacSystemFont, Segoe; //		UI, Roboto, Oxygen, //			Ubuntu, Cantarell, Fira; //		Sans,
// Droid; //		Sans, Helvetica; //		Neue, sans - serif; //		padding: var (; //	default
// //		-size - 0; //	) //		; //		margin: var (; //	default //		-size - 0; //	)
// //		; //		background - color; //	: //		var (; //		--color - grey - 500; //	)
// //		; //		color: var (; //		--color - grey - dark - 2; //	) //		; //	} // //	h1,
// //		h2, //		h3; //	{ // // //		font - family; //	: //		var (; //		--primary -
// display - font; //	) //		; //		font - weight; //	: //		400; //		font - style; //	:
// //		normal; // //	} // //	a; //	{ //		color: inherit; //		text - decoration; //	:
...
// ////.example { ////  font-family: "objektiv-variable", sans-serif; ////  font-variation-settings: 'wght' 400; ////}
// //// ////	                                           @import url("https://use.typekit.net/ptz3vfb.css");
// ////font-family: "louvette-banner", serif; ////font-weight: 400; ////font-style: normal; //// ////font-family:
// "louvette-banner", serif; ////font-weight: 400; ////font-style: italic; //// ////font-family: "louvette-banner",
// serif; ////font-weight: 700; ////font-style: normal;
